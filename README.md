<div align="center">
<img src="https://readme-typing-svg.herokuapp.com?font=Zen+Dots&size=38&duration=4000&pause=1000&color=38BDF8&center=true&vCenter=true&width=1050&lines=Hi%2C+I'm+Matias+Lopez+%F0%9F%91%8B;Software+Developer+%26+Data+Analyst;Backend+%C2%B7+Security+%C2%B7+Automation+%C2%B7+BI;Building+things+that+work+end-to-end." alt="Typing SVG" />
<br/>
...
matias = {
    ...
    "role"       : ["Software Developer", "Data Analyst", "Cybersecurity Learner"],
    "education"  : "Computer Engineering @ UdelaR",
    "stack"      : ["Python", "TypeScript", "Node.js", "SQL",
                    "PostgreSQL", "FastAPI", "Flask", "n8n", "Power BI"],
    "experience" : "1.5 years · backend, databases, BI & ERP implementation",
    "currently"  : "Building a Home SOC Lab + REST APIs + Python automations",
    "open_to"    : ["Software Development", "Backend Engineering",
                    "Security Analytics", "Data Analytics",
                    "Automation", "Remote & hybrid opportunities"],
}
```
...
|---|---|---|
| [🔍 home-soc-lab](https://github.com/lopez-matias/home-soc-lab) | Splunk · Sysmon · Kali · Python | Full SOC environment: attack simulation → detection → MITRE ATT&CK-mapped alerts |
| [⚡ fastapi-erp-connector](https://github.com/lopez-matias/fastapi-erp-connector) | FastAPI · PostgreSQL · Docker · GitHub Actions | Production REST API with JWT auth, Alembic migrations, Pytest coverage & CI/CD |
| [🤖 py-automation-kit](https://github.com/lopez-matias/py-automation-kit) | Python · n8n · OpenAI API · Pandas | Real automation scripts: report generation, data cleaning, AI-assisted workflows |
| [📊 bi-security-dashboard](https://github.com/lopez-matias/bi-security-dashboard) | Power BI · KQL · Sigma Rules | Security analytics dashboards built on SIEM data — Power BI meets Blue Team |
